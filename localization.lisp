...
(defun localization ()
  (if (= *language* 1)
      ...
      (and 
		 ...
		 (setf *key5* "This is me half a year ago. Do you know how to play? Press space to shoot the ball up (it's actually me). It will fly at an angle. The ball will destroy a red rectangular when hits it.")
		 ...
		 (setf *key10* "I've started to look for something. I didn't know what exactly I was looking for. A relief? Maybe...")
		 ...
		 (setf *key24* "At one moment I realised -- cats became a part of me. You are what you eat.")
